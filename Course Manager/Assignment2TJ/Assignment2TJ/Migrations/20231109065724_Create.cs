    ...
    public partial class Create : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Peter Madziak", "Programming Microsoft Web Technologies", "1C09", new DateTime(2024, 1, 18, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Students",
                columns: new[] { "StudentId", "CourseId", "Status", "StudentEmail", "StudentName" },
                values: new object[] { 1, 1, "ConfirmationNotSent", "bartsimpson@gmail.com", "Bart Simpson" });
